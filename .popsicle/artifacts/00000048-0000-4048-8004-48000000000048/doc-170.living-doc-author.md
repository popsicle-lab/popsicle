...
status: active
title: Phase D living-docs 同步
version: 1
---

# Phase D living-docs 同步

> target: tasks-index, product-header, proposed→linked
...
| `PRODUCT.md` | report 入口 + catalog |
| `ARCHITECTURE.md` | Phase D spec 待办 |
| `T-TEL-0002.md` | related_next → T-TEL-0004 |
| `issue PROJ-73` | proposed → linked T-TEL-0004 |

## Proposed → Linked

```bash
popsicle issue link PROJ-73 --tasks T-TEL-0004 --replace --drop-proposed
```
已执行。
