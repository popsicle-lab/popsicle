...
- [x] `products/agent-runtime/ARCHITECTURE.md` — P7 Tauri 表增 `daemon_start_cmd`/`daemon_stop_cmd`；Daemon 启动说明
- [x] `products/agent-runtime/tasks/onboarding/T-AR-0001-install-daemon.md` — 增加桌面 UI 启动路径

## Status

PROJ-93 交付：Settings 可一键启动/停止 Daemon；CLI 等价 `popsicle daemon start --background`。
