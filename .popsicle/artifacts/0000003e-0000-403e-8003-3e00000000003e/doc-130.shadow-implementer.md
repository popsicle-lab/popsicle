...
id: doc-130
pipeline_run_id: 0000003e-0000-403e-8003-3e00000000003e
status: active
title: PROJ-63 workspace 模块重命名
version: 1
---

# PROJ-63 workspace 模块重命名

## 变更

| 旧 | 新 |
|---|---|
| `self_host.rs` | `workspace.rs` |
| `SelfHostDomain` | `WorkspaceDomain` |
| `not_self_host()` | `not_workspace()` |
| `self_host_workflow_smoke_passes` | `workspace_workflow_smoke_passes` |

活文档：`ARCHITECTURE.md`、`PRODUCT.md`、ADR-032 File Manifest、UI baseline yaml。
